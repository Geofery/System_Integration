...
@app.get("/subscribe/{url}")
async def dad_joke_subscribe(url: str, response: Response):
    if url:
...
@app.get("/unsubscribe/{url}")
async def dad_joke_unsubscribe(url: str, response: Response):
    if url:
